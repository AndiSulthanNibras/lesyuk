        ...
        <div class="row1">
            <div>
                ...
                <div class="tmpt">
                    <h2>Tempat Kursus</h2>
                    <div class="row">
                        <p><i class="bi bi-geo-alt"></i> Rumah Alan:Gribig</p>
                        <p class="ap"> <i class="bi bi-camera-video"></i> Melalui aplikasi Zoom</p>
                    </div>
                </div>
                <div class="tnt">
                    <h2>Tentang Alan</h2>
                    <p>Mau belajar bahasa Inggris? Ayo belajar bareng bersama saya~ <br>Gak ada kata terlambat untuk
                        belajar bahasa inggris</p>
                    <p>Saya sudah memeberikan materi bahasa inggris selama 2 <br>tahun. Pengalaman yang saya miliki pun
                        hanya dari pelajaran <br>bahasa inggris disekolah saya dulu yang sekarang saya menjadi<br> guru
                        bahasa inggris di SMK Raden Umar Said Kudus.</p>
                    <p>Sampai saat ini saya sudah mengajar beberapa anak baik <br>secara privat maupun secara group.
                    </p>
                    <p>Saya mengedepankan hubungan intrapersonal yang baik <br>antara tutor dan pelajar sehingga pelajar
                        memiliki kepercayaan <br>diri untuk belajar</p>
                </div>
            </div>
                        ...
                        <div class="card5">
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    ...
                                    <a class="btn2" href="">Sesi ke 1 gratis</a>
